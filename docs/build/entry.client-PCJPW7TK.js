import{o as r}from"/single-cell-best-practices-zh/build/_shared/chunk-AQ2CODAG.js";import{a,c as l,d as i}from"/single-cell-best-practices-zh/build/_shared/chunk-JJXTQVMA.js";import{f as o}from"/single-cell-best-practices-zh/build/_shared/chunk-OZE3FFNP.js";var t=o(a()),m=o(l()),e=o(i());function d(){(0,t.startTransition)(()=>{(0,m.hydrateRoot)(document,(0,e.jsx)(t.StrictMode,{children:(0,e.jsx)(r,{})}))})}window.requestIdleCallback?window.requestIdleCallback(d):window.setTimeout(d,1);
...
/* scbp-zh-lang-guard */
;(function(){var watched,rootObserver=new MutationObserver(apply);function apply(){var root=document.documentElement;if(root&&root.lang!=="zh-CN")root.lang="zh-CN"}function watch(){var root=document.documentElement;if(root===watched)return;watched=root;rootObserver.disconnect();if(root)rootObserver.observe(root,{attributes:true,attributeFilter:["lang"]});apply()}watch();new MutationObserver(watch).observe(document,{childList:true})})();

/* scbp-index-redirect */
;(function(){var p=window.location.pathname;if(p.endsWith('/index.html'))window.location.replace((p.slice(0,-10)||'/')+window.location.search+window.location.hash);})();
